...
a persistence unit "ExamenFinalPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ExamenFinal/pom.xml":
...
artifact ("ExamenFinal.war") is already built. You can build
